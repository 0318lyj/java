...
public class BookExe2 {
	public static void main(String[] args) {
		Book2[] bookRepository = new Book2[100];
		bookRepository[0] = new Book2("이것이 자바다", "신용권", "한빛미디어", 30000);
		bookRepository[1] = new Book2("자바스크립트기초", "김기초", "한빛미디어", 20000);
		bookRepository[2] = new Book2("혼자공부하는 자바", "김자바", "자바출판사", 25000);
...
//			int Num1 = scn.nextInt()
			...
			case 2: //입력 
				...
				for(int i = 0; i < bookRepository.length; i++) {
					if(bookRepository[i] == null) {
						bookRepository[i] = new Book2(name,author,press,price);
